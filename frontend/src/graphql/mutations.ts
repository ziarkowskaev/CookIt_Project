...
// GraphQL Syntax Errors are raised when all commented mutations are uncommented
// They are missing the required fields for ratings, or recipes 
...
mutation CreateRecipe($name: String!, $description: String!, $ingredients: [String]!, $preparation: String!, $tags: [String]!, $images: [String]) {
    createRecipe(name: $name, description: $description, ingredients: $ingredients, preparation: $preparation, tags: $tags, images: $images) {
      name
      description
      ingredients
      preparation
